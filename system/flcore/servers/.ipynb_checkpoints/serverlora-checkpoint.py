...
class FLora(Server):
    def __init__(self, args, times):
        ...
        self.global_model = copy.deepcopy(self.model_object.get_lora_state_dict())    # dict of params
    ...
    def receive_models(self):
        ...
        for client in active_clients:
            ...
            if client_time_cost <= self.time_threthold:
                ...
                self.uploaded_models.append(client.model_object.get_lora_state_dict())
