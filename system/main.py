...
from dataset_config import get_num_labels
...
def run(args):
    ...
    for i in range(args.prev, args.times):
        ...
        # if model_str == "flora":
        #     args.model = DistilBertModelWithLoRA(model_id=args.model_id, home_dir=args.home_dir, lora_params=lora_params).to(args.device)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--lora_query', action='store_true', help="LoRA apply to query text")
    parser.add_argument('--lora_key', action='store_true', help="LoRA apply to key text")
    parser.add_argument('--lora_value', action='store_true', help="LoRA apply to value text")
    parser.add_argument('--lora_projection', action='store_true', help="LoRA apply to projection text")
    parser.add_argument('--lora_mlp', action='store_true', help="LoRA apply to MLP text")
    parser.add_argument('--lora_head', action='store_true', help="LoRA apply to head text")
    ...
    args.num_labels = get_num_labels(args.dataset)
    print(f'args.dataset: {args.dataset}')
    print(f'args.num_labels: {args.num_labels}')
    ...
    print("lora_query: {}".format(args.lora_query))
    print("lora_key: {}".format(args.lora_key))
    print("lora_value: {}".format(args.lora_value))
    print("lora_projection: {}".format(args.lora_projection))
    print("lora_mlp: {}".format(args.lora_mlp))
    print("lora_head: {}".format(args.lora_head))
